...
def main(argv):
    try:
        ...
        print('usage: training.py s- <training_strategy> -m <model_type=> -f <inference_fasta_file=> -r <inference_repr_dir> -p <predicted_z_scores_file>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('usage: training.py s- <training_strategy> -f <model_type=> -r <inference_fasta_file=> -r <inference_repr_dir> -p <predicted_z_scores_file>')
            sys.exit()
